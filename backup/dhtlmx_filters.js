...
class DateFilter extends ColumnFilter {
	...
	init() {
		...
		this.gantt.$container.addEventListener("click", (e) => {
			...
			const resetIcon = e.target.closest('.reset-filter-icon');
			if (resetIcon) {
				this.setValue({
					date: "",
					condition: ""
